...
public class UsuarioBean {
	...
	public UsuarioBean() {
		...
		if(atualizarUsuarioLogado()!=null)this.usuarioLogado=atualizarUsuarioLogado();
		

	}
	
	public Usuario atualizarUsuarioLogado() {
	...
	public void pesquisaGeral() {
		...
		usuarioPesquisa.setFuncao(this.funcaoPesquisa);
		System.out.println(usuarioPesquisa);
		this.usuarios = this.usuarioDao.pesquisarUsuario(usuarioPesquisa);
		this.quantPesquisada = this.usuarios.size();
	...
	public void remover() {
		...
		Usuario usuarioAtual = this.usuarioDao.pesquisar(this.usuario.getEmail());
		//usuarioAtual=this.usuario;
        System.out.println(usuarioAtual.getEmail());
	...
	public void salvar() throws IOException {
		...
		if (usuarioAtual != null) {
			...
			if (usuarioDao.inserir(this.usuario)) {
				...
				System.out.println(this.usuarioLogado);
				if(this.usuarioLogado!=null)abrirPesquisarUsuario();
				else abrirLogin();
	...
	public void abrirManterUsuario() throws IOException {
		...
		if(atualizarUsuarioLogado()!=null) FacesContext.getCurrentInstance().getExternalContext().redirect(Manter);
		else abrirLogin();
	}

	public void abrirPesquisarUsuario() throws IOException {
		if(atualizarUsuarioLogado()!=null)FacesContext.getCurrentInstance().getExternalContext().redirect(PESQUISAR);
		else abrirLogin();
	...
	public String getFuncaoPesquisa() {
		return funcaoPesquisa;
	}

	public void setFuncaoPesquisa(String funcaoPesquisa) {
